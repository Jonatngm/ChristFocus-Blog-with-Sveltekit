...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-50 px-4 py-12">
	<div class="w-full max-w-lg border-2 border-gray-200 rounded-2xl bg-white shadow-2xl interactive elevated">
		<div class="text-center space-y-6 p-10 border-b-2 border-primary bg-gradient-to-br from-primary/5 via-white to-primary/5">
			<div class="flex justify-center">
				<div class="bg-gradient-to-br from-primary to-gold-dark p-5 rounded-2xl shadow-lg">
		...
		<div class="p-10">
			{#if step === 'login'}
				<form on:submit={handleLogin} class="space-y-7">
					...
					<Button type="submit" class="w-full bg-gradient-to-r from-primary to-gold-dark hover:from-gold-dark hover:to-primary text-black font-bold py-4 rounded-xl transition-all duration-300 interactive elevated text-lg" disabled={loading}>
			...
			{:else if step === 'register'}
				<form on:submit={handleSendOtp} class="space-y-7">
					<div class="space-y-3">
						<label for="reg-email" class="text-sm font-bold text-foreground uppercase tracking-wide">Email</label>
						<input
							id="reg-email"
							type="email"
							bind:value={email}
