...
function Footer($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    Cross($$renderer2, { class: "w-5 h-5" });
    $$renderer2.push(`<!----> <span class="font-semibold text-lg">The Truth Hub</span></div> <p class="text-sm text-muted-foreground italic max-w-md">"I am the way, the truth, and the life" - John 14:6</p> <p class="text-xs text-muted-foreground">© ${escape_html(currentYear)} Emmanuel Victor Mucyo. All rights reserved.</p></div></div></footer>`);
  });
}
